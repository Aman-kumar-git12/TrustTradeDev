        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 h-fit sticky top-24">
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="status-all" className="ml-2 text-sm text-gray-600">All Statuses</label>
                        </div>
                        {STATUSES.map(status => (
                            <div key={status} className="flex items-center">
                                <input
                                    ...
                                    className="text-primary focus:ring-primary"
                                />
                                <label htmlFor={`status-${status}`} className="ml-2 text-sm text-gray-600 capitalize">{status}</label>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select
                        className="w-full p-2 border border-gray-200 rounded-lg text-sm focus:border-primary outline-none bg-white"
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        <input
                            type="number"
                            placeholder="Min"
                            className="w-1/2 p-2 border border-gray-200 rounded-lg text-sm focus:border-primary outline-none"
