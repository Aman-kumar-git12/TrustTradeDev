...
const ListingFilter = ({ filters, onFilterChange, onClear, onApply, onClose, hideStatus }) => {
    ...
    return (
        <div className="bg-white dark:bg-zinc-900 bluish:bg-gradient-to-br bluish:from-slate-800/80 bluish:to-slate-900/80 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800 bluish:border-white/5 p-6 h-fit sticky top-24 transition-colors duration-300">
            ...
            <div className="space-y-6">
                ...
                {!hideStatus && (
                    <div>
                        <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 bluish:text-slate-300 mb-2 transition-colors duration-300">Status</label>
                ...
                {/* Category */}
                <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 bluish:text-slate-300 mb-2 transition-colors duration-300">Category</label>
                    <select
                        className="w-full p-2 border border-gray-200 dark:border-zinc-700 bluish:border-white/10 rounded-lg text-sm focus:border-blue-500 outline-none bg-white dark:bg-zinc-800 bluish:bg-slate-800/50 text-gray-900 dark:text-white bluish:text-white transition-colors duration-300"
                ...
                {/* Price Range */}
                <div>
                    <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 bluish:text-slate-300 mb-2 transition-colors duration-300">Price Range</label>
                    <div className="flex gap-2">
                        <input
                            type="number"
                            placeholder="Min"
                            className="w-1/2 p-2 border border-gray-200 dark:border-zinc-700 bluish:border-white/10 rounded-lg text-sm focus:border-blue-500 outline-none bg-white dark:bg-zinc-800 bluish:bg-slate-800/50 text-gray-900 dark:text-white bluish:text-white transition-colors duration-300"
