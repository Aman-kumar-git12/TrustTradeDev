                                ...
                                {assets.map((asset) => (
                                    <Link to={`/assets/${asset._id}`} key={asset._id} className="group bg-white dark:bg-zinc-900 bluish:bg-[#131b2e] bluish:backdrop-blur-md rounded-xl border border-gray-200 dark:border-zinc-800 bluish:border-white/10 overflow-hidden hover:shadow-lg dark:hover:border-blue-500/50 bluish:hover:border-blue-500/50 bluish:hover:shadow-blue-500/10 transition-all h-full flex flex-col relative bluish:animate-fade-in-up hover:-translate-y-2">
                                        <div className="h-48 bg-gray-200 dark:bg-zinc-800 bluish:bg-[#0a0f1d] relative overflow-hidden">
                                            ...
                                            <div className="absolute top-4 right-4 bg-white/90 dark:bg-black/80 bluish:bg-black bluish:backdrop-blur-md px-3 py-1 rounded-full bluish:rounded-lg text-sm font-bold text-gray-900 dark:text-white bluish:text-white shadow-sm bluish:shadow-xl bluish:border bluish:border-white/10">
                                                ${asset.price.toLocaleString()}
                                            </div>
                                        </div>
                                        <div className="p-6 flex flex-col flex-grow">
                                            <div className="flex items-center text-xs text-blue-600 dark:text-emerald-400 bluish:text-white font-bold uppercase tracking-wider mb-2 bluish:bg-blue-600 bluish:backdrop-blur-md bluish:px-2.5 bluish:py-1 bluish:rounded-md bluish:w-fit bluish:shadow-lg">
