            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="bg-gray-100 dark:bg-zinc-800 rounded-2xl overflow-hidden aspect-[4/3] shadow-inner relative group transition-colors duration-300">
                    ...
                    <div className="absolute top-4 left-4">
                        <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide shadow-sm ${asset.status === 'active' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300' :
                ...
                <div className={`space-y-6 transition-all duration-300 ${isEditing ? 'bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-800' : ''}`}>
                    ...
                    {!isEditing ? (
                        <div className="flex items-center space-x-3 text-sm font-bold tracking-wider uppercase">
                            <span className="text-emerald-500 dark:text-emerald-400 flex items-center gap-1 transition-colors duration-300">
                                <Tag size={14} /> {asset.category}
                            </span>
                            <span className="text-gray-300 dark:text-zinc-700">•</span>
                            <span className="text-emerald-500 dark:text-emerald-400 transition-colors duration-300">
                                {asset.condition}
                            </span>
                        </div>
                    ) : (
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div className="flex flex-col">
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all cursor-pointer"
                                >
                                ...
                                {(!['Industrial', 'Vehicles', 'IT Hardware', 'Real Estate', 'Medical', 'Electronics', 'Manufacturing', 'Office Equipment'].includes(editForm.category)) && (
                                    <input
                                        ...
                                        className="mt-2 w-full px-3 py-2 border border-gray-200 dark:border-zinc-700 rounded-xl text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all"
                                        autoFocus
                                    />
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full pl-10 pr-4 py-3 text-xl font-bold text-gray-900 dark:text-white bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full pl-8 pr-4 py-3 text-xl font-bold text-gray-900 dark:text-white bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all"
                                        placeholder="Price"
                                    />
                                </div>
                            </div>
                            ...
                            {!isEditing ? (
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="border border-gray-200 dark:border-zinc-700 rounded-xl px-3 py-1 text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all"
                        ...
                        {!isEditing ? (
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full border border-gray-200 dark:border-zinc-700 rounded-xl p-4 text-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all shadow-sm"
                                    rows="6"
                    ...
                    <div className="bg-slate-50 dark:bg-zinc-800/50 rounded-xl p-6 border border-slate-100 dark:border-zinc-700 space-y-3 transition-colors duration-300">
                        <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-300">
                            <div className="w-8 flex justify-center mr-3">
                                <MapPin className="text-emerald-500 dark:text-emerald-400" />
                            </div>
                        ...
                        {isEditing ? (
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="flex-1 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 text-white py-3 px-6 rounded-xl font-bold transition-all shadow-lg shadow-emerald-200 dark:shadow-none flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                                >
