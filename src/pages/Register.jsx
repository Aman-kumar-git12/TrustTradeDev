                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className={`py-2 rounded-lg border font-medium ${formData.role === 'buyer' ? 'bg-primary text-white border-primary' : 'bg-white text-gray-600 border-gray-300'}`}
                            >
                                Buy Assets
                            </button>
                            <button
                                ...
                                className={`py-2 rounded-lg border font-medium ${formData.role === 'seller' ? 'bg-primary text-white border-primary' : 'bg-white text-gray-600 border-gray-300'}`}
                            >
                                Sell Assets
                            </button>
                        </div>
