...
function App() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-black bluish:bg-[#0a0f1d] text-gray-900 dark:text-gray-200 transaction-colors duration-300 relative overflow-x-hidden">
